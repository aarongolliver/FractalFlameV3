...
/*
 * Part of the Processing project - http://processing.org Copyright (c) 2005-12 Ben Fry and Casey
...
public final class PMatrix3D implements PMatrix /* , PConstants */{
	...
	/**
	 * Copies the matrix contents into a 16 entry double array. If target is null (or not the
	...
	public void apply(final double n00, final double n01, final double n02, final double n03, final double n10,
		...
		final double r00 = (m00 * n00) + (m01 * n10) + (m02 * n20) + (m03 * n30);
		final double r01 = (m00 * n01) + (m01 * n11) + (m02 * n21) + (m03 * n31);
		final double r02 = (m00 * n02) + (m01 * n12) + (m02 * n22) + (m03 * n32);
		final double r03 = (m00 * n03) + (m01 * n13) + (m02 * n23) + (m03 * n33);

		final double r10 = (m10 * n00) + (m11 * n10) + (m12 * n20) + (m13 * n30);
		final double r11 = (m10 * n01) + (m11 * n11) + (m12 * n21) + (m13 * n31);
		final double r12 = (m10 * n02) + (m11 * n12) + (m12 * n22) + (m13 * n32);
		final double r13 = (m10 * n03) + (m11 * n13) + (m12 * n23) + (m13 * n33);

		final double r20 = (m20 * n00) + (m21 * n10) + (m22 * n20) + (m23 * n30);
		final double r21 = (m20 * n01) + (m21 * n11) + (m22 * n21) + (m23 * n31);
		final double r22 = (m20 * n02) + (m21 * n12) + (m22 * n22) + (m23 * n32);
		final double r23 = (m20 * n03) + (m21 * n13) + (m22 * n23) + (m23 * n33);

		final double r30 = (m30 * n00) + (m31 * n10) + (m32 * n20) + (m33 * n30);
		final double r31 = (m30 * n01) + (m31 * n11) + (m32 * n21) + (m33 * n31);
		final double r32 = (m30 * n02) + (m31 * n12) + (m32 * n22) + (m33 * n32);
		final double r33 = (m30 * n03) + (m31 * n13) + (m32 * n23) + (m33 * n33);
	...
	public void preApply(final double n00, final double n01, final double n02, final double n03, final double n10,
		...
		final double r00 = (n00 * m00) + (n01 * m10) + (n02 * m20) + (n03 * m30);
		final double r01 = (n00 * m01) + (n01 * m11) + (n02 * m21) + (n03 * m31);
		final double r02 = (n00 * m02) + (n01 * m12) + (n02 * m22) + (n03 * m32);
		final double r03 = (n00 * m03) + (n01 * m13) + (n02 * m23) + (n03 * m33);

		final double r10 = (n10 * m00) + (n11 * m10) + (n12 * m20) + (n13 * m30);
		final double r11 = (n10 * m01) + (n11 * m11) + (n12 * m21) + (n13 * m31);
		final double r12 = (n10 * m02) + (n11 * m12) + (n12 * m22) + (n13 * m32);
		final double r13 = (n10 * m03) + (n11 * m13) + (n12 * m23) + (n13 * m33);

		final double r20 = (n20 * m00) + (n21 * m10) + (n22 * m20) + (n23 * m30);
		final double r21 = (n20 * m01) + (n21 * m11) + (n22 * m21) + (n23 * m31);
		final double r22 = (n20 * m02) + (n21 * m12) + (n22 * m22) + (n23 * m32);
		final double r23 = (n20 * m03) + (n21 * m13) + (n22 * m23) + (n23 * m33);

		final double r30 = (n30 * m00) + (n31 * m10) + (n32 * m20) + (n33 * m30);
		final double r31 = (n30 * m01) + (n31 * m11) + (n32 * m21) + (n33 * m31);
		final double r32 = (n30 * m02) + (n31 * m12) + (n32 * m22) + (n33 * m32);
		final double r33 = (n30 * m03) + (n31 * m13) + (n32 * m23) + (n33 * m33);
	...
	public PVector mult(final PVector source, PVector target) {
		...
		target.set((m00 * source.x) + (m01 * source.y) + (m02 * source.z) + m03, (m10 * source.x) + (m11 * source.y)
		        + (m12 * source.z) + m13, (m20 * source.x) + (m21 * source.y) + (m22 * source.z) + m23);
	 ...
	 * m22*source.z + m32; double tw = m03*source.x + m13*source.y + m23*source.z + m33; if (tw != 0
	 ...
	 * or 4, a new double array (length 3) will be returned.
	 */
	public double[] mult(final double[] source, double[] target) {
	...
	public double multX(final double x, final double y, final double z) {
		return (m00 * x) + (m01 * y) + (m02 * z) + m03;
	}

	public double multY(final double x, final double y, final double z) {
		return (m10 * x) + (m11 * y) + (m12 * z) + m13;
	}

	public double multZ(final double x, final double y, final double z) {
		return (m20 * x) + (m21 * y) + (m22 * z) + m23;
	}

	public double multW(final double x, final double y, final double z) {
		return (m30 * x) + (m31 * y) + (m32 * z) + m33;
	}

	public double multX(final double x, final double y, final double z, final double w) {
		return (m00 * x) + (m01 * y) + (m02 * z) + (m03 * w);
	}

	public double multY(final double x, final double y, final double z, final double w) {
		return (m10 * x) + (m11 * y) + (m12 * z) + (m13 * w);
	}

	public double multZ(final double x, final double y, final double z, final double w) {
		return (m20 * x) + (m21 * y) + (m22 * z) + (m23 * w);
	}

	public double multW(final double x, final double y, final double z, final double w) {
	...
	public boolean invert() {
		...
		final double t01 = -determinant3x3(m10, m12, m13, m20, m22, m23, m30, m32, m33);
		final double t02 = determinant3x3(m10, m11, m13, m20, m21, m23, m30, m31, m33);
		final double t03 = -determinant3x3(m10, m11, m12, m20, m21, m22, m30, m31, m32);

		// second row
		final double t10 = -determinant3x3(m01, m02, m03, m21, m22, m23, m31, m32, m33);
		final double t11 = determinant3x3(m00, m02, m03, m20, m22, m23, m30, m32, m33);
		final double t12 = -determinant3x3(m00, m01, m03, m20, m21, m23, m30, m31, m33);
		final double t13 = determinant3x3(m00, m01, m02, m20, m21, m22, m30, m31, m32);

		// third row
		final double t20 = determinant3x3(m01, m02, m03, m11, m12, m13, m31, m32, m33);
		final double t21 = -determinant3x3(m00, m02, m03, m10, m12, m13, m30, m32, m33);
		final double t22 = determinant3x3(m00, m01, m03, m10, m11, m13, m30, m31, m33);
		final double t23 = -determinant3x3(m00, m01, m02, m10, m11, m12, m30, m31, m32);

		// fourth row
		final double t30 = -determinant3x3(m01, m02, m03, m11, m12, m13, m21, m22, m23);
		final double t31 = determinant3x3(m00, m02, m03, m10, m12, m13, m20, m22, m23);
		final double t32 = -determinant3x3(m00, m01, m03, m10, m11, m13, m20, m21, m23);
		final double t33 = determinant3x3(m00, m01, m02, m10, m11, m12, m20, m21, m22);
	 ...
	 * @return result
	 */
	private double determinant3x3(final double t00, final double t01, final double t02, final double t10,
	        final double t11, final double t12, final double t20, final double t21, final double t22) {
	...
	protected boolean invApply(final double n00, final double n01, final double n02, final double n03,
	        final double n10, final double n11, final double n12, final double n13, final double n20, final double n21,
	        final double n22, final double n23, final double n30, final double n31, final double n32, final double n33) {
		if (inverseCopy == null) {
